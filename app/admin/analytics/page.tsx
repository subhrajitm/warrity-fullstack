  ...
  if (isLoading) {
    return (
      <div className="flex items-center justify-center h-full">
        <p className="text-amber-800 text-xl">Loading analytics data...</p>
      </div>
    )
  }
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid gap-6 md:grid-cols-2 mb-6">
            <Link href="/admin/analytics/products">
              <Card className="border-4 border-amber-800 shadow-[8px_8px_0px_0px_rgba(120,53,15,0.5)] bg-amber-100 hover:translate-y-[-4px] transition-transform cursor-pointer">
                <CardContent className="p-6 flex items-center justify-between">
                  <div>
                    <p className="text-2xl font-bold text-amber-900 mb-2">Product Analytics</p>
                    <p className="text-amber-800">Detailed insights about product performance, sales, and warranty registrations</p>
                  </div>
                  <div className="h-16 w-16 bg-amber-200 rounded-full flex items-center justify-center">
            ...
            <Link href="/admin/analytics/users">
              <Card className="border-4 border-amber-800 shadow-[8px_8px_0px_0px_rgba(120,53,15,0.5)] bg-amber-100 hover:translate-y-[-4px] transition-transform cursor-pointer">
                <CardContent className="p-6 flex items-center justify-between">
                  <div>
                    <p className="text-2xl font-bold text-amber-900 mb-2">User Analytics</p>
                    <p className="text-amber-800">User demographics, activity patterns, and warranty registration behavior</p>
                  </div>
                  <div className="h-16 w-16 bg-amber-200 rounded-full flex items-center justify-center">
